...
const dberror = DBG('notes:error-level');

let db;

// connect with the database
// createIfMissing creating a database if there is not one already
// the constructor function level creates a level instance connected to the database specified by the first argument
// the first argument is a location in the filesystem where the databse will be stored
// the level constructor returns a db object trhough with to interact with the database
